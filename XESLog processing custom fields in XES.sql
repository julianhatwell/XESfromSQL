...
DECLARE @EarliestIntakeStartDate datetime = '2014-04-01'
DECLARE @LatestIntakeStartDate datetime = '2014-04-30'
...
DECLARE @trace TABLE([case] varchar(50) NOT NULL PRIMARY KEY, [trace] xml)
...
DECLARE @event TABLE([case] varchar(50), [event] xml)
INSERT INTO @event([case], [event]) 
SELECT [log].[event].value('(case)[1]', 'varchar(50)'), 
[log].[event].query(
'<event>
